...
export class MantenimientoServicioNegocio extends Component {
    ...
    render() {
        return (
            <main>
                <div className="row-full">Mantenimiento de servicios por Línea Negocio </div>
                <Container>
                    <Row>
                        <Col md={4}>
                        ...
                        <Col md={4}>
                            <div className="item1">
                            <h6 className="heading4">Línea servicio </h6>
                                <input type="text" name="codigo_linea_servicio" />
                                </div>
                        </Col>
