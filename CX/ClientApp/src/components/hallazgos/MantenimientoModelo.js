...
export class MantenimientoModelo extends Component {
    ...
    render() {
        return (
            <main>
                <div className="row-full">Mantenimiento de Metedología del Modelo de Experiencia Cliente </div>
                <Container>
                    <Row>
                        <Col md={4}>

                            <div className="item1">
                                <h6 className="heading3">Metodología </h6>
                                <input type="text" name="codigo_modelo" />
                                <input type="text" name="descripcion_modelo" />
                            </div>
                        </Col>
                    ...
                    <table className="table table-bordered table" name="table_modelo">
