...
export class MantenimientoJefaturaDireccion extends Component {
    ...
    render() {
        return (
            <main>
                <div className="row-full">Mantenimiento de Jefaturas </div>
                <Container>
                    <Row>
                        <Col md={4}>

                            <div className="item1">
                                <h6 className="heading3">Jefatura </h6>
                                <input type="text" name="codigo_jefatura" />
                                <input type="text" name="descripcion_jefatura" />
                            </div>
                        </Col>

                        <Col md={4}>
                            <div className="item1">
                                <h6 className="heading4">Dirección </h6>
                    ...
                    <table className="table table-bordered table" name="table_jefatura">
                        <thead className="titulo2">
                            <tr >
                                <th>Código jefatura</th>
                                <th>Descripcion</th>
