...
namespace CX.Controllers
{
    ...
    public class RespuestasPreguntaEncuestaController : Controller
    {
        ...
        [HttpDelete("[action]")]
        public async Task<JsonResult> EliminarRespuestas(int idPreguntaEncuesta)
        {
            return Json(await this.servicioRespuestasPreguntaEncuesta.EliminarRespuestas(idPreguntaEncuesta));
        }
    }
}