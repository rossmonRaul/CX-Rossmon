...
namespace BussinesLogic.Servicios
{
    public class ServicioRespuestasPreguntaEncuesta: IServicioRespuestasPreguntaEncuesta
    {
        ...
        public async Task<DtoRespuestaSP> EliminarRespuestas(int idPreguntaEncuesta)
        {
            return await this.repositorioRespuestasPreguntasEncuesta.EliminarRespuestas(idPreguntaEncuesta);
        }
